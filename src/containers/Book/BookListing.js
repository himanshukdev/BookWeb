  ...
  return (
    ...
    {numSelected ? (
        <Typography className={classes.title} color="inherit" variant="subtitle1" component="div">
            The Book {nameSelected} has been selected.
        </Typography>
        ) : (
...
export default function EnhancedTable() {
  ...
  const booklist = useSelector(state=>state.app.bookListingData);
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, booklist.length - page * rowsPerPage);

  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected} nameSelected={seletedName} />
        <TableContainer>
          <Table
